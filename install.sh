...
if [ -f "/etc/debian_version" ]; then
        ...
        sudo git clone https://github.com/Jadify-eu/ddos/ > /dev/null 2>&1 || echo "[!] Could not download ddos."
        ...
        git clone https://github.com/Jadify-eu/ddos/ > /dev/null 2>&1 || echo "[!] Please install git"
        cd ddos
